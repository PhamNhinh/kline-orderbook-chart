...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/indicators](https://tapedelta.com/docs/charting-library/indicators)** — this Markdown mirror is kept for offline / GitHub browsing.
