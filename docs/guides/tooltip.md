...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/events-and-tooltips](https://tapedelta.com/docs/charting-library/events-and-tooltips)** — this Markdown mirror is kept for offline / GitHub browsing.
