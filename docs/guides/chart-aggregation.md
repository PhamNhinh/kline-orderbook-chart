...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/data-loading](https://tapedelta.com/docs/charting-library/data-loading)** — this Markdown mirror is kept for offline / GitHub browsing.
