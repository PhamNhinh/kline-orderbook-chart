...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/drawing](https://tapedelta.com/docs/charting-library/drawing)** — this Markdown mirror is kept for offline / GitHub browsing.
