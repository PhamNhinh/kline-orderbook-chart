...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/footprint-chart](https://tapedelta.com/docs/charting-library/footprint-chart)** — this Markdown mirror is kept for offline / GitHub browsing.
