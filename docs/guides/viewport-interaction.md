...
> 📖 **The canonical version of this page is now hosted at [https://tapedelta.com/docs/charting-library/chart-instance](https://tapedelta.com/docs/charting-library/chart-instance)** — this Markdown mirror is kept for offline / GitHub browsing.
